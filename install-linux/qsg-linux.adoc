...
* Sistema operativo: Red Hat Enterprise Linux versiones 7.x y de 8,0 a 8,6, o CentOS versión 7.x basada en la arquitectura x86_64, instalado utilizando el entorno base “Servidor con GUI” de la opción *Selección de software* del instalador del sistema operativo
